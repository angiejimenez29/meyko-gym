...
export function InstructorCard({ name, experienceYears, bio, whatsapp }: InstructorCardProps) {
  ...
  return (
    <div className="bg-[#151226]/80 rounded-3xl p-6 md:p-8 flex flex-col justify-between border border-white/10 shadow-xl shadow-black/20 hover:border-[#D6007A]/50 transition-colors group h-full">
      <div className="flex flex-col items-center text-center gap-4 mb-6">
        <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-[#D6007A] to-[#F9A826] p-1 shadow-lg group-hover:scale-105 transition-transform">
          <div className="w-full h-full bg-[#151226] rounded-full flex items-center justify-center border-2 border-[#151226]">
        ...
        <div>
          ...
          <div className="flex items-center justify-center gap-1.5 text-[#39FF14] text-xs font-semibold uppercase tracking-wider">
      ...
      <a 
        ...
        className="w-full bg-[#25D366]/10 text-[#25D366] font-bold py-3 rounded-xl flex items-center justify-center gap-2 text-sm hover:bg-[#25D366] hover:text-white transition-colors"
      >
