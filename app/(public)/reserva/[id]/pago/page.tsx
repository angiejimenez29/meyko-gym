          ...
          <div className="md:col-span-7 space-y-6 order-2 md:order-1">
            <div className="hidden md:flex items-center justify-between border-b border-foreground/5 pb-4">
              <div className="space-y-1">
                <p className="text-foreground/80 text-xs uppercase tracking-widest font-medium">Powered by Culqi</p>
            ...
            <div className="bg-container p-6 md:p-8 rounded-2xl border border-foreground/5 text-center space-y-6 shadow-lg">
              ...
              <div>
                <p className="text-foreground font-medium text-lg">Pago con Yape</p>
                <p className="text-foreground/70 text-sm px-6 mt-1">Serás redirigido de forma segura a la app de Yape para completar esta transacción.</p>
              </div>
