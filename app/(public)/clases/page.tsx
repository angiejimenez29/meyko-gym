  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-5 md:px-8 py-12 md:py-16 space-y-16">
      <div className="space-y-4 text-center md:text-left">
        <h1 className="text-3xl md:text-5xl font-bold text-white">Próximas Clases</h1>
        <p className="text-[15px] md:text-lg text-white/60">Encuentra tu horario ideal y asegura tu lugar en nuestras sesiones guiadas.</p>
      </div>

      <ClassFilters instructors={instructorsList} />

      {mappedSessions.length === 0 ? (
        <div className="text-center py-16 md:py-20 px-6 bg-white/5 rounded-3xl border border-white/10">
          <p className="text-[15px] md:text-lg text-white/60 font-medium leading-relaxed">No hay clases programadas por el momento. ¡Vuelve pronto!</p>
        </div>
      ) : (
